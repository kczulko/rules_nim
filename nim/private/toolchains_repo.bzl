...
# By default all these toolchains are registered by the nim_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:nim_toolchain",
    toolchain_type = "@rules_nim//nim:toolchain_type",
)
""".format(
            platform = platform,
